...
const ADHDProposal = () => {
  ...
  useEffect(() => {
    ...
    const newParticles = Array.from({ length: 25 }, (_, i) => ({
      ...
      delay: Math.random() * 5,
      color: ["#14b8a6", "#f43f5e", "#f59e0b", "#3b82f6", "#8b5cf6"][
          ...
          <section className="slide-up">
            <div className="glass rounded-3xl p-8 text-center section-card">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {["ตรวจเร็ว", "รู้ไว", "ไร้ตรา", "เด็กกล้าโต"].map(
                  (item, i) => (
                    <span
                      key={i}
          ...
          <section className="slide-up space-y-6">
            <div className="glass rounded-3xl p-8 section-card">
              ...
              >
                ...
                <span
                  className={`transition-transform ${showFullBackground ? "rotate-180" : ""}`}
                >
                  ▼
                </span>
              </button>
              ...
              <div
                className={`expand-content ${showFullBackground ? "open" : ""}`}
              >
          ...
          <section className="slide-up space-y-6">
            <div className="glass rounded-3xl p-6 md:p-8 section-card">
              ...
              <div className="mb-8">
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div
                    ...
                    onClick={() =>
                      setActiveFramework(
                        activeFramework === "pillar1" ? null : "pillar1",
                      )
                    }
                  >
                  ...
                  <div
                    ...
                    onClick={() =>
                      setActiveFramework(
                        activeFramework === "pillar2" ? null : "pillar2",
                      )
                    }
                  >
                    <div className="flex items-center gap-3 mb-4">
              ...
              <div className="relative rounded-3xl p-8 md:p-12 min-h-[500px]">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8 justify-center">
                    ...
                    <div className="liquid-glass-card p-6 text-center min-w-[140px] hover:scale-105 transition-all duration-500">
                      ...
                      <div className="font-bold text-slate-800 mt-3 text-lg">
                        PROBLEM
                      </div>
                    ...
                    <div className="lg:hidden text-4xl text-slate-300 animate-bounce">
                      ↓
                    </div>
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="liquid-glass-card-rose px-8 py-4 text-center hover:scale-105 transition-all duration-500 cursor-pointer">
                        ...
                        <div className="font-bold text-white text-lg mt-1 drop-shadow">
                          Policy Push
                        </div>
                    ...
                    <div className="lg:hidden text-4xl text-emerald-400 animate-bounce">
                      ↓
                    </div>
                ...
                {/* Full overlay when showDetails is active - covers entire flowchart area */}
                {overlayVisible && (
                  <div
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3
                          className={`font-bold text-${obj.color}-800 text-lg mb-1`}
                        >
                          {obj.title}
                        </h3>
        ...
        <footer className="mt-10">
          <div className="glass rounded-2xl p-6 text-center">
            ...
            <p className="text-slate-400 text-sm">
              โครงการ ADHD to Ability © 2569 | Young Policy Makers #2
            </p>
